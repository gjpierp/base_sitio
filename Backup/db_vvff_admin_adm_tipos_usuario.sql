...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tipos de usuario del sistema';
...
INSERT INTO `adm_tipos_usuario` VALUES (1,'Administrador','Usuario con todos los privilegios',1),(2,'Operador','Usuario con permisos limitados',1),(4,'Usuario','Usuario con permisos limitados',1),(5,'Invitado','Usuario sin permisos',1);
