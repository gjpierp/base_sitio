...
// GET /api/estados/buscar/id/:id - Buscar estado por id (alias a /:id)
router.get(
  "/buscar/id/:id",
  [validarJWT, validarRol("ADMIN_ROLE"), campoNumerico("id", "ID inválido"), validarCampos],
  obtenerEstado
);

// GET /api/estados/buscar/nombre/:nombre - Buscar estado por nombre/descripcion
router.get(
