...
const { getUsuariosPaginados, getDocumentosColeccion } = require("../controllers/busquedas");
const {
  asignarRoles,
  obtenerRolesUsuario,
...
router.get(
  "/buscar/id/:id",
  [validarJWT, validarRol("ADMIN_ROLE"), campoNumerico("id", "No es un ID válido"), validarCampos],
  getUsuarioPorId
);
