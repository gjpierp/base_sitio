...
ALTER TABLE adm_temas_valores
  ADD CONSTRAINT IF NOT EXISTS fk_valores_tema FOREIGN KEY (id_tema) REFERENCES adm_temas(id_tema) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE adm_temas_valores
  ADD CONSTRAINT IF NOT EXISTS fk_valores_var FOREIGN KEY (id_tema_var) REFERENCES adm_temas_variables(id_tema_var) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE adm_usuarios
  ADD COLUMN IF NOT EXISTS id_configuracion_default INT NULL,
  ADD INDEX idx_usuarios_conf_default (id_configuracion_default);

ALTER TABLE adm_usuarios
  ADD CONSTRAINT IF NOT EXISTS fk_usuarios_conf_default FOREIGN KEY (id_configuracion_default) REFERENCES adm_configuraciones_tema(id_config) ON DELETE SET NULL ON UPDATE CASCADE;
