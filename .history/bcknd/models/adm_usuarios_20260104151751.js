...
/**
 * @description Obtiene un usuario por correo o nombre de usuario (compatibilidad).
 * @author Gerardo Paiva
 * @date 04-01-2026
 * @param {string} correo - Correo o nombre de usuario a buscar.
...
AdmUsuarios.obtenerPorCorreo = async function (correo) {
  ...
  try {
    const [rows] = await BaseModel.query(
      "SELECT * FROM adm_usuarios WHERE correo_electronico = ? LIMIT 1",
      [correo]
    );
...
/**
 * @description Alias de compatibilidad para `findById`.
 * @author Gerardo Paiva
 * @date 04-01-2026
 */
...
/**
 * @description Alias que devuelve roles de un usuario.
 * @author Gerardo Paiva
 * @date 04-01-2026
 * @param {number} id_usuario - Identificador del usuario.
 * @returns {Promise<Array>} Lista de roles.
...
/**
 * @description Alias que devuelve permisos de un usuario.
 * @author Gerardo Paiva
 * @date 04-01-2026
 * @param {number} id_usuario - Identificador del usuario.
 * @returns {Promise<Array>} Lista de permisos.
