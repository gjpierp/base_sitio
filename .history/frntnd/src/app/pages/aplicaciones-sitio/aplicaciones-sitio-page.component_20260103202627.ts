...
import { NgIf, NgForOf, NgSwitch, NgSwitchCase, NgSwitchDefault, JsonPipe } from '@angular/common';
...
export class AplicacionesSitioPageComponent implements OnInit {
  ...
  async onModalConfirm() {
    ...
    try {
      ...
      try {
        console.debug('[AplicacionesSitio] onModalConfirm: modalEditingId=', this.modalEditingId, 'computed id=', id, 'payload=', payload);
      } catch {}
      if (id === null || id === undefined) {
        try {
