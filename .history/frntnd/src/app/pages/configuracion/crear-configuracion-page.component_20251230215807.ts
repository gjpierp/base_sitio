...
import { UiEntityFormComponent, FieldDef } from "../../components/ui-templates/ui-entity-form/ui-entity-form.component";
...
export class CrearConfiguracionPageComponent implements OnInit {
  ...
  fields: FieldDef[] = [
    ...
    { key: 'activo', label: 'Activo', type: 'select', options: [{ label: 'Sí', value: true }, { label: 'No', value: false }] },
  ];
