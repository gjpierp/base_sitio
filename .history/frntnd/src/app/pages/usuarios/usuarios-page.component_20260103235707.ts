    ...
    try {
      ...
      (async () => {
        try {
          ...
          const erows = (eres as any)?.data || (eres as any) || [];
          ...
          if (uid) {
            try {
              ...
              if (
                ...
                this.modalValues['id_rol'] = String(
                  assignedRoles[0].id_rol ?? assignedRoles[0].id ?? assignedRoles[0].id_rol
                );
              }
            } catch (e) {
              console.debug('[openEditModal] roles fetch error', e);
            }
            ...
            try {
              ...
              if (
                ...
                this.modalValues['id_jerarquia'] = String(
                  asociaciones[0].id_jerarquia ?? asociaciones[0].id ?? ''
                );
              }
            } catch (e) {
              console.debug('[openEditModal] usuarios_jerarquias fetch error', e);
            }
          }
