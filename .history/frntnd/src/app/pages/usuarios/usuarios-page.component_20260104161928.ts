...
export class UsuariosPageComponent implements OnInit {
  ...
  async openEditModal(usuario: any) {
    try {
      ...
      this.modalTitle = 'Editar usuario';
      this.modalDeleteMode = false;
      // Open modal immediately showing spinner, then load data in background
      try {
        console.log(
          '[UsuariosPage] opening modal immediate (spinner) modalFields.len=',
        ...
        console.debug('[UsuariosPage] start background open error', e);
      }
      (async () => {
        try {
          ...
          // All background loads finished: update values, clear loading and refresh view
          try {
            this.modalLoading = false;
          } catch {}
          try {
            // ensure new references so ngModel picks up changes immediately
            try {
