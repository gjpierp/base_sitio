...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, UiCardComponent, UiSpinnerComponent],
  ...
  async cargarPorId(id: string) {
    ...
    try {
      ...
      if (row) {
        ...
        this.modelo.primaryColor = row.primaryColor ?? row.primary_color ?? this.modelo.primaryColor;
        this.modelo.secondaryColor = row.secondaryColor ?? row.secondary_color ?? this.modelo.secondaryColor;
