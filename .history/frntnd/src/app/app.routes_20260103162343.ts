  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'usuarios/crear',
        loadComponent: () =>
          import('./pages/usuarios/crear-usuario-page.component').then(
            (m) => m.CrearUsuarioPageComponent
          ),
        canActivate: [authGuard],
      ...
      {
        path: 'tipos-usuarios/crear',
        loadComponent: () =>
          import('./pages/tipos_usuarios/crear-tipos-usuarios-page.component').then(
            (m) => m.CrearTiposUsuariosPageComponent
          ),
        canActivate: [authGuard],
        data: { title: 'Crear Tipo usuario', breadcrumb: 'Crear Tipo usuario' },
      },
      {
        path: 'roles-permisos',
        loadComponent: () =>
      ...
      {
        path: 'roles-permisos/crear',
        loadComponent: () =>
          import('./pages/roles_permisos/crear-roles-permisos-page.component').then(
            (m) => m.CrearRolesPermisosPageComponent
          ),
        canActivate: [authGuard],
        resolve: { pre: permisosResolver },
        data: { title: 'Crear Rol-Permiso', breadcrumb: 'Crear Rol-Permiso' },
      },
      {
        path: 'menus',
        loadComponent: () =>
      ...
      },
      {
        path: 'menus/crear',
        loadComponent: () =>
          import('./pages/menus/crear-menus-page.component').then((m) => m.CrearMenusPageComponent),
        canActivate: [authGuard],
        data: { title: 'Crear Menú', breadcrumb: 'Crear Menú' },
      },
      {
        path: 'estados',
        loadComponent: () =>
      ...
      },
      {
        path: 'estados/crear',
        loadComponent: () =>
          import('./pages/estados/crear-estados-page.component').then(
            (m) => m.CrearEstadosPageComponent
          ),
        canActivate: [authGuard],
        resolve: { pre: estadosResolver },
        data: { title: 'Crear Estado', breadcrumb: 'Crear Estado' },
      },
      {
        path: 'jerarquias',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/jerarquias/crear-jerarquias-page.component').then(
            (m) => m.CrearJerarquiasPageComponent
          ),
        canActivate: [authGuard],
        data: { title: 'Crear Jerarquía', breadcrumb: 'Crear Jerarquía' },
      },
      {
      ...
      {
        path: 'aplicaciones-sitio/crear',
        loadComponent: () =>
          import('./pages/aplicaciones-sitio/crear-aplicaciones-sitios-page.component').then(
            (m) => m.CrearAplicacionesSitioPageComponent
          ),
        canActivate: [authGuard],
        data: { title: 'Crear Aplicación', breadcrumb: 'Crear Aplicación' },
      },
      {
        path: 'auditoria',
        loadComponent: () =>
      ...
      },
      {
        path: 'sitios/crear',
        loadComponent: () =>
          import('./pages/sitios/crear-sitios-page.component').then((m) => m.CrearSitiosPageComponent),
        canActivate: [authGuard],
        data: { title: 'Crear Sitio', breadcrumb: 'Sitios' },
      },
